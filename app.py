...
"""     
        ...
        consist_df=consist_df[['year','profit_volatility']]
        st.dataframe(consist_df)
...
with tab5:
    with st.expander("Show Recommendations"):
        ...
        st.header("Score based recommender")
...
"""
        recomm_df=run_query(recomm_query)
        st.dataframe(recomm_df)
